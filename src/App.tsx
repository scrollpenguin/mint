              ...
              {dropNotReady ? (
                ...
                <div className="flex w-full flex-col gap-4">
                  <div className="flex w-full flex-col gap-4 lg:flex-row lg:items-center lg:gap-4 ">
                    <div style={{borderWidth: "thick", background: "white"}} className="flex h-11 w-full rounded-lg border border-gray-400 px-2 dark:border-gray-800 md:w-full">
                      <button
                        onClick={() => {
                      ...
                      <p style={{color: "black"}}  className="flex h-full w-full items-center justify-center text-center font-mono dark:text-white lg:w-full">
                    ...
                    <Web3Button
                      ...
                      onError={(err) => {
                        ...
                        console.log({ err });
                        toast({
                          title: "Not enough gas or Cancelled",
                          duration: 9000,
                          variant: "destructive",
                        });
                      }}
